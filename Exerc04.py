...
#CT0104 – Quarta contribuição da primeira etapa                                                            #
...
#############################A versão RECURSIVA deste algoritmo mostrou-se mais eficiente(e de rápida execução) do que sua versão ITERATIVA, portanto o ALUNO escolheu usá-la...
...
#O que estiver comentado no código da função abaixo foi usado para gerar os outros gráficos(Da LISTA CRESCENTE E DA QUE POSSÚI ELEMENTOS TODOS IGUAIS que o aluno decidiu fazer apenas para fins acadêmicos).
#Implementação do aluno#####################################################################################################################################################################################################################################################################################
def cria_Graficos(lista_entrada):                                                                                                                                                                                                                                                                          #
  ...
  for i in lista_entrada:                                                                                                                                                                                                                                                                                  #
    ...
    num_iteracoes = 0                                                                                                                                                                                                                                                                                      #
                                                                                                                                                                                                                                                                                                           #
  desenhaGrafico(lista_entrada,tempos_orden,"GraficoQuickSort(Tamanho_Lista-X-Tempo_Ordenacoes)Decrescente.png", "Tempo(Lista->Decrescente)",'(Quick Sort-Lista Decrescente)Tamanho_Lista X Tempo_Ordenacoes','black',"<Entradas/>","<Tempo-Saída/>")                                                      #
  desenhaGrafico(lista_entrada, numer_iteracoes,"GraficoQuickSort(Tamanho_Lista-X-Numero_Iteracoes)Decrescente.png", "Numero_Iteracao(Lista->Decrescente)",'(Quick Sort-Lista Decrescente)Tamanho_Lista X Numero_Iteracoes','grey',"<Entradas/>","<'Swaps'(Num_Iterações)-Saída/>")                        #
                                                                                                                                                                                                                                                                                                           #
  #desenhaGrafico(lista_entrada,tempos_orden_2,"GraficoQuickSort(Tamanho_Lista-X-Tempo_Ordenacoes)Crescente.png", "Tempo(Lista->Crescente)",'(Quick Sort-Lista Crescente)Tamanho_Lista X Tempo_Ordenacoes','black',"<Entradas/>","<Tempo-Saída/>")                                                         #
  #desenhaGrafico(lista_entrada, numer_iteracoes_2,"GraficoQuickSort(Tamanho_Lista-X-Numero_Iteracoes)Crescente.png", "Numero_Iteracao(Lista->Crescente)",'(Quick Sort-Lista Crescente)Tamanho_Lista X Numero_Iteracoes','yellow',"<Entradas/>","<'Swaps'(Num_Iterações)-Saída/>")                         #
                                                                                                                                                                                                                                                                                                           #
  #desenhaGrafico(lista_entrada,tempos_orden_3,"GraficoQuickSort(Tamanho_Lista-X-Tempo_Ordenacoes)Elementos-Todos-Iguais.png", "Tempo(Lista->Elementos Iguais)",'(Quick Sort-Lista Elementos Iguais)Tamanho_Lista X Tempo_Ordenacoes','black',"<Entradas/>","<Tempo-Saída/>")                              #
  #desenhaGrafico(lista_entrada, numer_iteracoes_3,"GraficoQuickSort(Tamanho_Lista-X-Numero_Iteracoes)Elementos-Todos-Iguais.png", "Numero_Iteracao(Lista->Elementos Iguais)",'(Quick Sort-Lista Elementos Iguais)Tamanho_Lista X Numero_Iteracoes','blue',"<Entradas/>","<'Swaps'(Num_Iterações)-Saída/>")#
                                                                                                                                                                                                                                                                                                           #
############################################################################################################################################################################################################################################################################################################
